...
blender -b SET.blend --disable-autoexec --python art/aurora/validate_blender.py
...
def validate(output=None):
    ...
    assert scene.get("armor_set") == "frostweave" and scene.get("armor_title") == "T90 Aurora", "Expected the T90 Aurora assembly."
    ...
    assert record_names == source_names == {f"frostweave_{piece}.glb" for piece in ("hood", "robe", "leggings", "boots", "wraps")}
    ...
    report = {
        ...
        "title": scene["armor_title"], "tier": scene["armor_tier"],
