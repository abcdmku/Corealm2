...
const generatorSha256 = Object.fromEntries(await Promise.all(['tools/creature-motion/suid-gait.ts', 'tools/creature-motion/stage-suid-gaits.ts', 'tools/creature-motion/pose.ts', 'tools/lib/ground-gait.ts', 'tools/repair-ground-creature-gaits.ts'].map(async file => [file, sha(await readFile(file))])));
