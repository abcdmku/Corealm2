...
const generatorSha256 = Object.fromEntries(await Promise.all(['tools/creature-motion/cervine-gait.ts', 'tools/creature-motion/stage-cervine-gaits.ts', 'tools/lib/ground-gait.ts', 'tools/repair-ground-creature-gaits.ts'].map(async file => [file, sha(await readFile(file))])));
