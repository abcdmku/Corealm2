...
out=Path('test-results/roach-source')
bpy.ops.wm.open_mainfile(filepath=str(Path('test-results/fantasy-collection-source/roach-game-ready-and-animated/Roach.blend').resolve()),load_ui=False,use_scripts=False)
