...
export const CreatureProfileSchema = obj({
  ...
  attackSpeedMs: int({ min: 1 }, { label: 'Attack interval', unit: 'ms', group: 'curve' }), goldPerLevel: num({ min: 0 }, { label: 'Gold per level', group: 'curve' }),
});
...
export const CreatureLootSchema = LootPlanSchema;
