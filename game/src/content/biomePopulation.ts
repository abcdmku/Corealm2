...
import { BIOME_REPLACEMENT_SPECIES } from './enemyData.js';

/** Stable replacement identities are projected from the canonical encounter alias records. */
export const BIOME_POPULATION_LEGACY_REPLACEMENTS: Readonly<Record<string,string>> = BIOME_REPLACEMENT_SPECIES;
