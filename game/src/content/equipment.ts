...
const MELEE_TIER_1: readonly ItemDef[] = [
  ...
  gear({
    id: "grithe_ring", name: "Copper Ring", tier: 1, slot: "accessory1", value: 95,
    description: "A plain band set with a chip of quartz.",
    requires: { melee: 1 },
    bonuses: { accuracy: 1 },
  }),
  gear({
    id: "grithe_pendant", name: "Copper Pendant", tier: 1, slot: "accessory2", value: 105,
    description: "Trade Company issue. The stamp on the back is a serial number, not a blessing.",
    requires: { melee: 1 },
...
const MELEE_TIER_5: readonly ItemDef[] = [
  ...
  gear({
    id: "corven_ring", name: "Iron Ring", tier: 5, slot: "accessory1", value: 330,
    description: "Iron band, amber set flush so it does not catch.",
    requires: { melee: 5 },
    bonuses: { accuracy: 1 },
  }),
  gear({
    id: "corven_pendant", name: "Iron Pendant", tier: 5, slot: "accessory2", value: 360,
    description: "A slice of amber on an Iron chain. Warm, which nobody has explained.",
    requires: { melee: 5 },
...
const MELEE_TIER_10: readonly ItemDef[] = [
  ...
  gear({
    id: "kaldite_ring", name: "Cobalt Ring", tier: 10, slot: "accessory1", value: 780,
    description: "A heavy band, garnet-set. It has a quarry number filed into the inside.",
    requires: { melee: 10 },
    bonuses: { accuracy: 1 },
  }),
  gear({
    id: "kaldite_pendant", name: "Cobalt Pendant", tier: 10, slot: "accessory2", value: 840,
    description: "Garnet in a Cobalt claw. Cold no matter how long you wear it.",
    requires: { melee: 10 },
...
const MELEE_TIER_20: readonly ItemDef[] = [
  ...
  gear({
    id: "emberite_ring", name: "Titanium Ring", tier: 20, slot: "accessory1", value: 1750,
    description: "A warm band set with a fire opal. The Ashford smith stamps a kiln mark inside.",
    requires: { melee: 20 },
    bonuses: { accuracy: 2 },
  }),
  gear({
    id: "emberite_pendant", name: "Titanium Pendant", tier: 20, slot: "accessory2", value: 1900,
    description: "A fire opal in a Titanium claw. It glows faintly when the wearer stops moving.",
    requires: { melee: 20 },
...
const MAGIC_TIER_10: readonly ItemDef[] = [
  ...
  gear({
    ...
    description: "It ticks against other metal. Nobody in Hillcrest will keep one in a drawer.",
    requires: { magic: 10 },
...
export const RARE_MINIBOSS_WEAPONS: readonly ItemDef[] = [
  rare(meleeBase("grithe_sword"), "galeskin_sword", "Plains Ogre Sword",
