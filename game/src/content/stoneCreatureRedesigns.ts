...
export const STONE_CREATURE_REDESIGNS: readonly CreatureSpeciesDef[] = [
  { id: 'cairn_treader', source: 'shale_elemental', name: 'Cairn Treader', regionId: 'karrowmoor', tier: 10, health: 52,
  ...
  { id: 'flint_mandible', source: 'beetle_golem', name: 'Flint Mandible', regionId: 'karrowmoor', tier: 10, health: 46,
  ...
  { id: 'vault_custodian', source: 'iron_golem', name: 'Vault Custodian', regionId: 'gravelmaw', tier: 10, health: 64,
    description: 'A walking remnant of a sealed vault. Its hollow masonry chest and massive lintel arms close around intruders.' },
  { id: 'blind_cave_weaver', source: 'webweaver_spider', name: 'Blind Cave Weaver', regionId: 'gravelmaw', tier: 10, health: 30,
  ...
  { id: 'scree_watcher', source: 'stone_golem', name: 'Scree Watcher', regionId: 'karrowmoor', tier: 10, health: 40,
  ...
  return { id: row.id, assetId: `creature_${row.id}`, regionId: row.regionId as CreatureSpeciesDef['regionId'],
    scale: 1, activity: 'patrol', description: row.description,
