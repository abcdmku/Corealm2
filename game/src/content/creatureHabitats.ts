...
const STAGED_CREATURE_HABITATS: readonly StagedCreatureHabitat[] = [
  ...
  {
    speciesId: "rootdelve_badger", assetId: "creature_rootdelve_badger", enemyDefId: "redmane_minotaur_t25",
    groupId: "rootdelve_badger_residents", habitatId: "rootfall_south_stump_belt_habitat",
    regionId: "vellenwood", tier: 25, activity: "patrol", count: 2,
    centre: [64,77], radius: 7,
    anchors: [[60,76], [68,78], [64,82], [61,72], [68,73]],
    settingId: "rootfall_south_stump_belt",
    rationale: "A proposed stump belt south of Rootfall offers a separate minotaur territory beyond the palisade and bank routes.",
    ...
    dressingNotes: ["A stump and fern frame the minotaur territory; neither adds a hollow or burrowing interaction. Source screening reserves a 2.75 m body radius plus each measured prop radius, 0.25 m plant sway and at least 1 m beyond every straight anchor connection. Actual terrain, collision and navigation remain unaccepted."],
  },
  {
