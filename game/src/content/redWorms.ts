...
/** Small field worm from Worms FREE, with its darker source red texture. */
export const RED_WORM_SPECIES: readonly CreatureSpeciesDef[] = [{
  id: 'red_worm', assetId: 'creature_red_worm', scale: 4.8, regionId: 'fallowmarch', activity: 'forage',
