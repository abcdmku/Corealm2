...
export const SHOPS: readonly ShopDef[] = [
  {
    ...
    stock: [
      ...
      { itemId: "focus_rune", quantity: 120 },
  ...
  },
  {
    ...
    stock: [
      ...
      { itemId: "focus_rune", quantity: 120 },
      { itemId: "sweep_rune", quantity: 120 },
      { itemId: "field_rune", quantity: 200 },
  ...
  },
  {
    ...
    stock: [
      ...
      { itemId: "sweep_rune", quantity: 120 },
      { itemId: "binding_rune", quantity: 100 },
      { itemId: "field_rune", quantity: 200 },
  ...
  },
  {
    ...
    stock: [
      ...
      { itemId: "binding_rune", quantity: 100 },
      { itemId: "siege_rune", quantity: 80 },
      { itemId: "cataclysm_rune", quantity: 50 },
      { itemId: "field_rune", quantity: 200 },
