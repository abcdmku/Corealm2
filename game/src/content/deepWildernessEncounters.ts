...
export const DEEP_WILDERNESS_PACKS: readonly DeepWildernessPackPlan[] = [
  ...
  { id: 'wilderness_foundry_north_carapaces', speciesId: 'rift_carapace', centre: [-304, 804], count: 7, radius: 28, bodyRadius: 2.5 },
  ...
  { id: 'wilderness_northwest_red_dragons', speciesId: 'red_wilderness_dragon', centre: [-271, 907], count: 7, radius: 34, bodyRadius: 5.5 },
  { id: 'wilderness_central_purple_dragons', speciesId: 'purple_wilderness_dragon', centre: [7, 803], count: 7, radius: 34, bodyRadius: 5.7 },
  { id: 'wilderness_eastern_red_dragons', speciesId: 'amethyst_dragon', centre: [233, 866], count: 7, radius: 34, bodyRadius: 5.5 },
  { id: 'wilderness_eastern_gloam_conclave', speciesId: 'gloam_wraith', centre: [317, 796], count: 7, radius: 28, bodyRadius: 1.5 },
  { id: 'wilderness_sanctum_east_carapaces', speciesId: 'rift_carapace', centre: [146, 885], count: 7, radius: 28, bodyRadius: 2.5 },
  { id: 'wilderness_sanctum_west_colossi', speciesId: 'voidstone_colossus', centre: [-89, 860], count: 7, radius: 28, bodyRadius: 3.3 },
