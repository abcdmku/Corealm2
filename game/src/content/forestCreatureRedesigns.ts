...
export const FOREST_CREATURE_REDESIGNS: readonly CreatureSpeciesDef[] = [
  { id: 'briar_harrow', source: 'mossback_sentinel', name: 'Briar Harrow', regionId: 'vellenwood',
  ...
  { id: 'fen_crawler', source: 'webweaver_spider', name: 'Fen Crawler', regionId: 'vellenwood',
  ...
  { id: 'reed_strider', source: 'webweaver_spider', name: 'Reed Strider', regionId: 'vellenwood',
  ...
  { id: 'thorn_maw', source: 'beetle_golem', name: 'Thorn Maw', regionId: 'vellenwood',
  ...
  { id: 'heath_jack', source: 'goblin_scout', name: 'Heath Jack', regionId: 'fallowmarch',
  ...
  return {
    id: row.id, assetId: `creature_${row.id}`, scale: 1,
