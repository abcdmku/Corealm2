...
const armature = doc.createNode('TanBullHornDemonArmature').setScale([presentationScale,presentationScale,presentationScale]); scene.addChild(armature); armature.addChild(meshNode);
