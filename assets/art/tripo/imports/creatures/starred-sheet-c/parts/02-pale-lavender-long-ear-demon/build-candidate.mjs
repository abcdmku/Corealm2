...
const armature=doc.createNode('PaleLavenderLongEarDemonArmature').setScale([rigScale,rigScale,rigScale]); scene.addChild(armature); armature.addChild(meshNode);
...
const checkScene=check.listScenes()[0],checkArmature=checkScene.listChildren().find(n=>n.getName()==='PaleLavenderLongEarDemonArmature');
