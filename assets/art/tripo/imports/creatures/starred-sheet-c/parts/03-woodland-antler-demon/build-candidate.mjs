...
const armature=doc.createNode('WoodlandAntlerDemonArmature').setScale([rigScale,rigScale,rigScale]); scene.addChild(armature); armature.addChild(meshNode);
...
const checkScene=check.listScenes()[0],checkArmature=checkScene.listChildren().find(n=>n.getName()==='WoodlandAntlerDemonArmature');
