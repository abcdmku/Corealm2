...
const sourcePath = path.join(repo, 'assets/art/tripo/exports/corealm_vaultweaver_0ea08166_8k_rigged.glb');
...
const outputPath = path.join(here, 'starred-vaultweaver-candidate.glb');
...
const catalog = {
  ...
  accepted: false,
  source: {
    file: 'assets/art/tripo/exports/corealm_vaultweaver_0ea08166_8k_rigged.glb',
    sha256: sourceHash,
