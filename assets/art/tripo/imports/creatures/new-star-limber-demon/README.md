...
The rig has Idle, Walk, Run, Attack, Hit, and Death clips. The build samples each clip in Three.js and adds root-height correction keys to keep the deformed mesh above the floor. Death requires the largest sampled lift, 0.58 m; review its final pose and fall in the production-backed lab before acceptance.
