...
export interface FormulaBuildStatus { state: 'idle' | 'checking' | 'valid' | 'invalid'; revision?: string; diagnostics: {path:string;message:string;severity:'error'|'warning'|'info'}[]; }
