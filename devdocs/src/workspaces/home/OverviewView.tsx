  ...
  return <div className="ws-page ws-page-narrow home-overview">
    ...
    {!__DEVDOCS_PLAYER__ && <div className="home-columns">
      <section className="home-block">
        <header><h2>Open requests</h2><button className="text-button" onClick={() => navigate("home/requests")}>All requests <ArrowRight size={12} /></button></header>
      ...
      <section className="home-block">
        <header><h2>Local changes</h2><button className="text-button" onClick={() => navigate("home/changes")}>Review <ArrowRight size={12} /></button></header>
