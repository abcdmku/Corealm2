...
The 54 ordinary encounters keep their original group IDs, tiers, resident counts and combat balance. Stable stat aliases retain their original drops and gold while taking the new family's name and rig movement speeds. All 21 displaced expansion trophies, plus fox crafting material, remain obtainable for existing recipes. The seven bosses retain their Orb and rare equipment drops and Ordrun's phase thresholds. New roaming packs use regional combat tiers: 1 in Fallowmarch, 5 in Vellenwood, 10 in Karrowmoor and 20 in Kilnhalt and the Wilderness.
