...
| `regions` | All seven original-region boss singletons, their native replacement bodies, canonical health and levels at 3–5 times regional tier, real grounded movement and one normal-camera capture per boss. Ordrun uses the existing production cave loader and its observed navigation floor. |
