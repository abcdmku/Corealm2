...
| Image approved; P1 geometry pass, texture queued | Undercrag Mawer P1 trial (separate from older candidate) | Reuses the exact approved image. Smart Mesh P1.0 model `3b76bc22-c899-46f8-b518-3873e4244072` has 5,484 faces; independent Astra-low four-view geometry review approved it and Smart UV is complete. Tripo's 2K texture job is queued, not complete; rig, PBR, export, lab, and game acceptance remain pending. |
