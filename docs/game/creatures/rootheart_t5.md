...
description: "Rootbound Colossus spawn locations, combat stats, and drops."
---
...
<figure class="corealm-location-map corealm-creature-map" data-location-map
 data-map-focus="57.818,63.152,57.818,63.152"
...
<a class="corealm-map-marker" href="../../regions/#ash-border" style="--map-x:57.8182%;--map-y:63.1515%" data-map-side="right" data-map-kind="enemy" data-map-marker aria-label="Rootbound Colossus, Ash Border, Woodlands" title="Rootbound Colossus, Ash Border, Woodlands"><span>Rootbound Colossus<small>Ash Border, Woodlands</small></span></a>
</div>
...
| --- | --- | --- | --- |
| [Woodlands](../../regions/#ash-border) | [Ash Border](../../regions/#ash-border) | Rootbound Colossus | 1 |
...
<div class="codex-card"><span class="codex-card__text"><span class="codex-card__title">Gold</span><span class="codex-card__meta">350-550 per kill</span><span class="codex-card__footer"><span class="codex-tags"><span class="codex-tag">Always</span></span></span></span></div>
