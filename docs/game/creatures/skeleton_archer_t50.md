...
<div class="corealm-quest-scenes"><figure class="corealm-quest-scene"><img src="../../assets/captures/enemy-groups/black_keep_gate_archers.webp" alt="Skeleton Archer at its authored spawn in Wilderness" loading="lazy" /><figcaption><strong>Skeleton Archer</strong><span>Black Knight Gate, Wilderness</span></figcaption></figure></div>
...
<a class="corealm-map-marker" href="../../regions/#black-knight-gate" style="--map-x:54.5000%;--map-y:41.3636%" data-map-side="right" data-map-kind="enemy" data-map-marker aria-label="Skeleton Archer, Black Knight Gate, Wilderness" title="Skeleton Archer, Black Knight Gate, Wilderness"><span>Skeleton Archer<small>Black Knight Gate, Wilderness</small></span></a>
</div>
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 50 | 129 | 48 | 34 | 12 | 11 | 2.0 s | 10 | 15 | aggressive | 10 m |
...
| --- | --- | --- |
| Marks | 50-150 | Always |
| [Grave Thread](../../items/grave_thread/) | 1-3 | 100% |
| [Cosmic Rune](../../items/cosmic_rune/) | 2-4 | 40% |
| [Mind Rune](../../items/mind_rune/) | 2-4 | 40% |
| [Chaos Rune](../../items/chaos_rune/) | 2-3 | 28% |
