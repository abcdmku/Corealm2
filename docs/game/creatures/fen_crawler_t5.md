...
<dl class="codex-stats"><div><dt>Tier</dt><dd>5</dd></div><div><dt>Health</dt><dd>13</dd></div><div><dt>Attack</dt><dd>4</dd></div><div><dt>Defence</dt><dd>3</dd></div><div><dt>Accuracy</dt><dd>6</dd></div><div><dt>Max hit</dt><dd>2</dd></div><div><dt>Attack speed</dt><dd>2.0 s</dd></div><div><dt>Armour</dt><dd>5</dd></div><div><dt>Magic armour</dt><dd>8</dd></div><div><dt>Behaviour</dt><dd>Aggressive</dd></div><div><dt>Aggro</dt><dd>10 m</dd></div></dl>
