...
<a class="corealm-map-marker" href="../../regions/#river-shallows" style="--map-x:45.3333%;--map-y:67.2500%" data-map-side="right" data-map-kind="enemy" data-map-marker aria-label="Frog, River Shallows, Farmland" title="Frog, River Shallows, Farmland"><span>Frog<small>River Shallows, Farmland</small></span></a>
</div>
