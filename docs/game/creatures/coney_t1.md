...
<a class="corealm-map-marker" href="../../regions/#the-broken-milestone" style="--map-x:38.3333%;--map-y:62.8571%" data-map-side="right" data-map-kind="enemy" data-map-marker aria-label="Rabbit, The Broken Milestone, Farmland" title="Rabbit, The Broken Milestone, Farmland"><span>Rabbit<small>The Broken Milestone, Farmland</small></span></a>
</div>
