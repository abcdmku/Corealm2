...
<a class="corealm-map-marker" href="../../regions/#north-gate" style="--map-x:35.6364%;--map-y:68.4848%" data-map-side="right" data-map-kind="enemy" data-map-marker aria-label="Fen Crawler, North Gate, Farmland" title="Fen Crawler, North Gate, Farmland"><span>Fen Crawler<small>North Gate, Farmland</small></span></a>
</div>
...
<dl class="codex-stats"><div><dt>Tier</dt><dd>1</dd></div><div><dt>Health</dt><dd>3</dd></div><div><dt>Attack</dt><dd>1</dd></div><div><dt>Defence</dt><dd>1</dd></div><div><dt>Accuracy</dt><dd>1</dd></div><div><dt>Max hit</dt><dd>1</dd></div><div><dt>Attack speed</dt><dd>2.0 s</dd></div><div><dt>Armour</dt><dd>1</dd></div><div><dt>Magic armour</dt><dd>2</dd></div><div><dt>Behaviour</dt><dd>Aggressive</dd></div><div><dt>Aggro</dt><dd>10 m</dd></div></dl>
