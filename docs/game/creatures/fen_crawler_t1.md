...
<figure class="corealm-location-map corealm-creature-map" data-location-map
 data-map-focus="44.833,68.485,44.833,68.485"
...
<a class="corealm-map-marker" href="../../regions/#north-gate" style="--map-x:44.8333%;--map-y:68.4848%" data-map-side="right" data-map-kind="enemy" data-map-marker aria-label="Fen Crawler, North Gate, Farmland" title="Fen Crawler, North Gate, Farmland"><span>Fen Crawler<small>North Gate, Farmland</small></span></a>
</div>
