...
<a class="corealm-map-marker" href="../../regions/#the-broken-milestone" style="--map-x:43.0833%;--map-y:62.9643%" data-map-side="right" data-map-kind="enemy" data-map-marker aria-label="Turkey, The Broken Milestone, Farmland" title="Turkey, The Broken Milestone, Farmland"><span>Turkey<small>The Broken Milestone, Farmland</small></span></a>
</div>
