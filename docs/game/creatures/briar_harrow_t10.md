...
<div class="corealm-quest-scenes"><figure class="corealm-quest-scene"><img src="../../assets/captures/enemy-groups/marsh_moose_residents.webp" alt="Briar Harrow at its authored spawn in Woodlands" loading="lazy" /><figcaption><strong>Briar Harrow</strong><span>Blackwater Pools, Woodlands</span></figcaption></figure></div>
...
<a class="corealm-map-marker" href="../../regions/#blackwater-pools" style="--map-x:62.5000%;--map-y:61.5714%" data-map-side="left" data-map-kind="enemy" data-map-marker aria-label="Briar Harrow, Blackwater Pools, Woodlands" title="Briar Harrow, Blackwater Pools, Woodlands"><span>Briar Harrow<small>Blackwater Pools, Woodlands</small></span></a>
</div>
...
| --- | --- | --- | --- |
| [Woodlands](../../regions/#blackwater-pools) | [Blackwater Pools](../../regions/#blackwater-pools) | Briar Harrow | 2 |

## Stats

| Tier | Health | Attack | Defence | Accuracy | Max hit | Attack speed | Armour | Magic armour | Behaviour | Aggro |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 10 | 64 | 16 | 10 | 6 | 9 | 3.4 s | 16 | 15 | territorial | 7 m |
