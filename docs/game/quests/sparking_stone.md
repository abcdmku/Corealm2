...
<img class="codex-shot" src="../../assets/captures/npcs/npc_quarrier_vess.webp" alt="Quarrier Vess in the running Corealm world" width="960" height="540" loading="lazy" decoding="async" />
