...
| --- | --- | --- | --- | --- |
| [Seamer Juno](../../npcs/#seamer-juno) | [Oakwood](../../regions/#oakwood) | [Woodlands](../../regions/#woodlands) | None | None |
...
### 1. Fletch 4 Pine shafts at a fletching bench.
...
<a class="corealm-map-marker" href="../../regions/#millfield-bank" style="--map-x:35.4667%;--map-y:65.0375%" data-map-side="right" data-map-kind="entity" data-map-marker aria-label="Millfield Fletching Bench, Farmland" title="Millfield Fletching Bench, Farmland"><span>Millfield Fletching Bench<small>Farmland</small></span></a>
<a class="corealm-map-marker" href="../../regions/#pine-grove" style="--map-x:22.1667%;--map-y:63.3750%" data-map-side="right" data-map-kind="grove" data-map-marker aria-label="Pine Grove, Farmland" title="Pine Grove, Farmland"><span>Pine Grove<small>Farmland</small></span></a>
</div>
...
<figcaption>Pine Grove, Millfield Square.</figcaption>
</figure>
</div>
...
### 2. Mine 5 Air Essence from the distant Farmland cache.
...
<div class="corealm-map-stage" data-map-stage>
<img src="../../assets/world-map.webp" alt="Overhead map rendered from the Corealm game world" draggable="false" />
<a class="corealm-map-marker" href="../../npcs/#seamer-juno" style="--map-x:54.8667%;--map-y:51.3000%" data-map-side="right" data-map-kind="npc" data-map-marker aria-label="Seamer Juno, Woodlands" title="Seamer Juno, Woodlands"><span>Seamer Juno<small>Woodlands</small></span></a>
</div>
<span class="corealm-map-north" aria-hidden="true">N</span>
<div class="corealm-map-controls corealm-map-controls-zoom" aria-label="Map zoom controls">
<button type="button" data-map-action="out" aria-label="Zoom out" title="Zoom out">&minus;</button>
