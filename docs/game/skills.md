...
| Level | Unlocks |
| --- | --- |
| 1 | Copper Seam yields Copper Ore, plus Quartz, Limestone Face yields Limestone, plus Quartz |
| 5 | Iron Seam yields Iron Ore, plus Amber |
...
| Level | Unlocks |
| --- | --- |
| 1 | 1× Copper Bar, 1× Copper Dagger, 1× Copper Sword, 1× Copper Helm, 1× Copper Cuirass, 1× Copper Greaves, 1× Copper Boots, 1× Copper Gloves, 1× Copper Pickaxe, 1× Copper Hatchet |
| 5 | 1× Iron Bar, 1× Iron Dagger, 1× Iron Sword, 1× Iron Helm, 1× Iron Plate, 1× Iron Greaves, 1× Iron Boots, 1× Iron Gauntlets, 1× Iron Pickaxe, 1× Iron Hatchet |
...
| Level | Unlocks |
| --- | --- |
| 1 | River Shallow yields Minnow |
| 5 | Blackwater Pool yields Trout |
...
| Level | Unlocks |
| --- | --- |
| 1 | Pine yields Pine Log |
| 5 | Ash yields Ash Log |
...
| Level | Unlocks |
| --- | --- |
| 1 | 4× Pine Shaft, 2× Pine Handle, 1× Pine Staff, 1× Pine Wand, 1× Pine Shield, 1× Pine Rod, 1× Basic Wooden Wand, 1× Basic Wooden Staff |
| 5 | 4× Ash Shaft, 2× Ash Handle, 1× Ash Staff, 1× Ash Wand, 1× Ash Shield, 1× Ash Rod, 1× Ash Rod, 1× Ash Shield |
