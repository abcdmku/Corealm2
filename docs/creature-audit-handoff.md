...
Production catalog now has 51 entries. Remaining original verdicts: 52 replacements and 41 polish assets. Vault Custodian and Faeholme Nightbloom are promoted in the second continuation batch. Their source preservation commit is 72ddc08. Fresh whole-corpse views passed at normal camera angles; Vault combat showed 38 -> 35 -> 29 HP and Nightbloom 724 -> 715 -> 695 HP with Attack. Vault scale is 0.84. Typecheck, the six focused files / 35 tests, content validation and production build passed for this second batch. Luna source review found no defects. The first Vault world check was interrupted by a stopped development server and failed model requests; representative world acceptance remains pending. Silverthorn needs final side-fall death acceptance. Flint shrinking-corpse repair is now visually accepted and preserved in e96445c, but not yet promoted. Beetle Golem is rejected as a repeated Flint silhouette and flagged to the user as an additional source gap. Do not redo these four promoted assets from the original verdict table.
...
- Production-only accepted catalog: test-results/creature-audit/production-candidates.json, 51 entries.
...
| --- | --- | --- |
| Silverthorn Harrow / creature_silverthorn_harrow | audit-rootwood-family | Floating cone crown removed. Previous backflip corpse REJECTED. Latest side-fall rebuild SHA 3e6d131045b9c29ae59896f7b74c76a8d34cb0f10a646f5260df4ab934ba47a3 was superseded by SHA 44d1d614531df7708ad19098c3f13da99e9ae84476cb626b83e14510881f04ae after reviewing an upright-looking corpse. That version was superseded again by SHA 63c449e627572a60f277b11051b9ea75dacdff4da94174e1573268a6b19499ed: natural sidefall, folded limbs, no scaling, sampled ground contact. CPU final height 0.711m; needs runtime screenshot. Rootheart bytes were unchanged. |
| Nightbloom / fairy_guardian_06_faeholme | audit-nightbloom | Promoted. Idle, attack/damage and whole grounded corpse passed. Correct preset species:guardian_06_faeholme, derived level189. This does NOT resolve fantasy_monster_06. |
| Vault Custodian / creature_vault_custodian | audit-vault-custodian | Owned limestone/blue-sash sentinel, 54 joints/eight clips, CPU grounding passed. Latest SHA 7fd6db127e826c93f4c54f3322f0da0798bdb627d937fa5be2c07457035f9d67. Promoted after fresh visual, combat and grounded whole-death acceptance; production scale 0.84. Preset species:vault_custodian. |
| Flint Mandible / creature_flint_mandible | audit-mandible-family | Charcoal/flint/bronze generated skin, 30 joints/six clips. Round4 idle/walk captures queued, not accepted. Alive/combat checked. Repaired SHA ea7bed07eeb44578a0804af603489601f0659d50d7ee366c8714fe24ce4ebe82 removes root-scale shrink. Fresh full-width folded-leg corpse accepted by root/Luna. Source e96445c preserved; ready for promotion. |
| Beetle Golem / creature_beetle_golem | audit-mandible-family | Basalt/oxidized copper/moss skin on same mandible source, raw1.554m. REJECTED: enlarged Flint silhouette does not read as a distinct construct. Additional source gap flagged to user; no generation jobs. Currently same derived level13/reward as Flint; if larger, increase level/reward appropriately. |
