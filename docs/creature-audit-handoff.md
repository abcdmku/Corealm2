...
| Beetle Golem / creature_beetle_golem | audit-mandible-family | REJECTED: enlarged Flint silhouette does not read as a distinct construct. Candidate preserved, production unchanged. Additional source gap flagged to user; no generation jobs. |
